function [ Dict1, Dict2, Dict3 ] = Create_Dictionaries( Cell1, Cell2, Cell3 )
%Create_Dictionaries
%   Creating container maps-the same function as Python dictionaries for
%   "translating":
%       1.metabolite names into their ChEBI identifiers
%       2.ChEBI Identifiers into InChI identifiers for standardised
%       elements
%       3.chemical formulas of each metabolite into their ChEBI identifiers
%   
%   Returns 3 Map structures including:
%       
%   
%   Usage: [Dict1, Dict2, Dict3]=Create_Dictionaries(Cell1, Cell2, Cell3)
%
